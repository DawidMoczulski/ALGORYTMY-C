...
void DodajNowyElWart(lista *l, int y){
    ...
    // if ((*l)->klucz > y) {
    //     printf("(*l)->klucz > y: %d > %d",(*l)->klucz, y );
    //     DodajPoczatek(l, y);
    //     return;
    // }
    while ( ((*l)->klucz != INT_MAX) && ((*l)->klucz <= y) ) {
        printf("(*l)->klucz: %d \n", (*l)->klucz);
        //  if((*(&(*l)->nast))->klucz == INT_MAX){
        //     printf("(*(&(*l)->nast))->klucz: %d \n", (*(&(*l)->nast))->klucz);
        //     break;
        //  }  
         l = &((*l)->nast); 
    }
...
// void Kobus_Sort(lista *student){
    
//     for(int i=0; i<liczba_debili; i++){
//        string zajebistyGrader;
//        if(zajebistyGrader.powie == "nope"){
//          printf("Nie zdales Kobusowego Sortu:)");
//        }
//        else if (zajebistyGrader.powie == "Kozak"){
           
//            if(NajlepszyEgzamin.ocena > 2){
//               Niemozliwe();
//               ChodzNaDopytke();
//               printf("I tak nie zdales.");          
//            }
//            else{
//             printf("Ubijamy cie jak proces.");
//            }
//        }
