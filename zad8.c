...
void OriginalElements(lista *l, lista *q) {
    int eq = 0;
    lista r = *q;
    while (*l != NULL) {
        int liczba = (*l)->klucz;
...
void OriginalElementsWart(lista *l, lista *q){
    int eq = 0;
    lista r = *q;
    ...
    do{
        ...
        switch(wart){
            ...
            do{
                ...
                printf("8. Oczysc listy ze wspolnych elementow. \n");
                printf("0. Wstecz.\n");
                printf("Podaj numer: ");
                scanf("%d",&wybor);
